          ...
          <Card className="border-0 shadow-xl backdrop-blur-sm bg-card/95">
            ...
            <CardContent>
              ...
              <div className="flex justify-center">
                <Button className="w-full h-12 bg-black hover:bg-gray-800 text-white transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl">
